package com.vanja1942ns.shoppinglist;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Creating list from database and showing off to listViewer
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //Botton add item to add items to the list
    ...
    //Converting all words to UpperCased
        if (original.isEmpty())
            return original;
